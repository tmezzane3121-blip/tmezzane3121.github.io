...
Ce projet a été réalisé dans le cadre de ma formation en 2ème année d'informatique à la Faculté des Sciences Semlalia, Marrakech. 

L'objectif est de concevoir un CV en ligne moderne et interactif en mobilisant trois technologies complémentaires du 
...
Les composants React sont montés via ReactDOM.createRoot() dans des <div> conteneurs placés dans le HTML. La validation jQuery 

utilise la délégation d'événement ($(document).on()) pour interagir avec le formulaire généré par React.
